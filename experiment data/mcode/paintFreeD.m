function [ output_args ] = paintFreeD( n )
...
x = [1 2]';
m = n(6,:);
plot(x,m(1:2),'Color',[255/255 196/255 8/255],'Marker','+','LineStyle',':','LineWidth',1.5),
hold on
x = [1 2 3 4]';
m = n(7,:);
plot(x,m(1:4),'Color',[224/255 60/255 138/255],'Marker','V','LineStyle','--','LineWidth',1.5),
%hold on
hold on
...
title('Additional test cases from free degree, k = 8')
